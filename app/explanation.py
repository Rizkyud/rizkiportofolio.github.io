...
def app():
    ...
    acc = acc.astype(int)
    with col1:
        st.subheader("**Explanation Model DecisionTree**"), \
    ...
    with col4:
        st.write(''), \
            ...
            st.write(
                '**Pada Model Klasifikasi ini mesin berhasil mengatasi kesalahan fatal tersebut dengan hasil 0 pada False Negative**')
